...
import com.elcomrades.problemstack.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/problem-stack-kafka")
public class ProblemStackKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ProblemStackKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public ProblemStackKafkaResource(KafkaProperties kafkaProperties) {
